...
static retro_core_option_v2_definition option_defs[] =
{
	...
	},
	{
		...
		"Emulação",
		{
			...
			{ "inside", "Tente usar o 'dosbox.conf' no conteúdo carregado (ZIP ou pasta)" },
			{ "outside", "Tente '.conf' com o mesmo nome do conteúdo carregado (próximo ao ZIP ou à pasta)" },
		},
		"false"
	},
	{
	...
	},
	{
		...
		"Ajuste fino do desempenho emulado para necessidades específicas." "\n\n", NULL, //end of Performance > Detailed section
		"Desempenho",
		{
			{ "0.2",  "20%" }, { "0.25",  "25%" }, { "0.3",  "30%" }, { "0.35",  "35%" }, { "0.4",  "40%" }, { "0.45",  "45%" },
			{ "0.5",  "50%" }, { "0.55",  "55%" }, { "0.6",  "60%" }, { "0.65",  "65%" }, { "0.7",  "70%" }, { "0.75",  "75%" },
...
"Vídeo",
	...
	},
	{
		...
		"Emulador 3dfx Voodoo Graphics SST-1/2 por Aaron Giles e a equipe do MAME (licença: BSD de 3 cláusulas)", NULL,
		"Vídeo",
		{
			{ "12mb", "Ativado - 12MB de memória (padrão)" },
			{ "4mb", "Ativado - 4MB de memória" },
			{ "off", "Desativado" },
		},
		"12mb",
	},
	{
		"dosbox_pure_voodoo_perf",
			"Configurações de Desempenho 3dfx Voodoo", NULL,
			"Opções para ajustar o comportamento da emulação 3dfx Voodoo.", NULL,
			"Vídeo",
		{
			{ "1", "Multi-threading (padrão)" },
